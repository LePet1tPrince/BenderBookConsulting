    ...
    return (
        <div className="">
            <div className="text-center font-72 bold">Why Choose Us?</div>
                <div className="container d-flex align-items-center justify-content-center flex-wrap fullscreen ">

                    <div class="card text-white border-0 m-5">
                        <img src={whyus1} class="card-img rounded-5" alt="Shopkeeper" width="500" height="350"/>
                    ...
                    <div class="card text-white border-0 m-5">
                        <img src={whyus2} class="card-img rounded-5" alt="Shopkeeper"  width="500" height="350"/>
                        <div class="card-img-overlay hover-appear rounded-5">
                    ...
                    <div class="card text-white border-0 m-5">
                        <img src={whyus3} class="card-img rounded-5" alt="Shopkeeper"  width="500" height="350"/>
                        <div class="card-img-overlay hover-appear rounded-5">
                            <h5 class="card-title font-40 bold px-4">We </h5>
                            <p class="card-text font-20 px-4">Did you know if you hire your child to work for your business, they should not pay employment insurance? Neither did our client, Stacy, until she hired us to manage her payroll. Imagine her surprise when we got the CRA to put an extra $1200 in her pocket.</p>
                        </div>
                    </div>

                    <div class="card text-white border-0 m-5">
                        <img src={shopkeeper} class="card-img rounded-5" alt="Shopkeeper"  width="500" height="350"/>
                        <div class="card-img-overlay hover-appear rounded-5">
